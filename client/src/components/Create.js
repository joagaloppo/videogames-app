...
export default function Create() {
	...
	return (
		<div className={styles.home}>
			...
			<h2 className={styles.title}>Add custom game</h2>

			<div className={styles.container}>
				<div className={styles.form_container}>
					<form className={styles.create} onSubmit={(e) => e.preventDefault()}>
						...
						<div className={styles.left}>
							...
							<div className={styles.section}>
								...
								<div className={styles.closure}>
									<label>Name *</label>
									<input className={styles.input} name="name" onChange={(e) => handleChange(e)} value={input.name} />
								</div>
							</div>
						...
						<div className={styles.right}>
							<div className={styles.section}>
								...
								<div className={styles.closure_description}>
									<label>Description *</label>
									<textarea className={styles.input} name="description" onChange={(e) => handleChange(e)} value={input.description} />
								</div>
							</div>
						...
						<button className={styles.submit} onClick={(e => handleSubmit(e) )} >Create</button>
				</div>
			</div>
		</div>
	);
